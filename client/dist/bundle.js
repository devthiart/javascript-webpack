...
//Importamos o CSS do bootstrap dentro dos módulos no node. Para buscar nos módulos do node, não coloque
// o ./ no inicio do endereço. Se colocar ./ ele vai buscar na pasta atual.


//Como já estamos importando o plugin pelo webpack.config usando o webpack, nao precisamos mais importá-lo
//por aqui.
//import 'jquery/dist/jquery.js';

//Importamos o meu css da pasta css, não da pasta dos módulos do node.
...
let NegociacaoController = (_dec = __WEBPACK_IMPORTED_MODULE_2__util_index_js__["c" /* controller */]('#data', '#quantidade', '#valor'), _dec2 = __WEBPACK_IMPORTED_MODULE_2__util_index_js__["b" /* bindEvent */]('submit', '.form'), _dec3 = __WEBPACK_IMPORTED_MODULE_2__util_index_js__["d" /* debounce */](), _dec4 = __WEBPACK_IMPORTED_MODULE_2__util_index_js__["b" /* bindEvent */]('click', '#botao-importa'), _dec5 = __WEBPACK_IMPORTED_MODULE_2__util_index_js__["d" /* debounce */](), _dec6 = __WEBPACK_IMPORTED_MODULE_2__util_index_js__["b" /* bindEvent */]('click', '#botao-apaga'), _dec(_class = (_class2 = class NegociacaoController {
    ...
    importaNegociacoes() {
        ...
        return _asyncToGenerator(function* () {
            ...
            try {
                //Não precisa mais do System, mas precisa instalar o plugin "babel-plugin-syntax-dynamic-import".
                const { NegociacaoService } = yield (/*System.*/__webpack_require__.e/* import() */(0).then(__webpack_require__.bind(null, 45))
                );
